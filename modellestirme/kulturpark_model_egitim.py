# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 01:17:03 2020
...
veri_kpark= pd.read_excel("data_kulturpark.xlsx")

train = veri_kpark.drop(["Unnamed: 0","Unnamed: 0.1"], axis=1)
