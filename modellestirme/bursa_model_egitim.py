# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 00:44:11 2020
...
veri_universite = pd.read_excel("data_universite.xlsx")
veri_bursa = pd.read_excel("data_bursa.xlsx")
veri_beyazid = pd.read_excel("data_beyazid.xlsx")
veri_inegol = pd.read_excel("data_inegol.xlsx")
veri_kestel = pd.read_excel("data_kestel.xlsx")
veri_kulturpark = pd.read_excel("data_kulturpark.xlsx")

train = veri_bursa.drop(["Unnamed: 0","Unnamed: 0.1"], axis=1)
